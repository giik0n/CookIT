    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reserPass.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {// відновлення паролю
                ...
                builder.setTitle(R.string.passwordRestore);
                builder.setMessage(R.string.enterYourEmail);
        ...
        loginButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {// вхід
                loadBar.setTitle(getString(R.string.logginingIn));
                loadBar.setMessage(getString(R.string.pleaseWait));
                loadBar.show();
                String email = userEmail.getText().toString();
                String pass = userPass.getText().toString();

                if(email.isEmpty() || pass.isEmpty()){
                    Toast.makeText(LoginActivity.this, R.string.fillAllTheFields, Toast.LENGTH_SHORT).show();
                }else{
                    mAuth.signInWithEmailAndPassword(email,pass).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {// якщо логін і пароль вірні переходимо на домашній єкран
                            if (task.isSuccessful()){
                                Toast.makeText(LoginActivity.this, R.string.youAreLoggedIn, Toast.LENGTH_SHORT).show();
        ...
        mGoogleSignInClient = new GoogleApiClient.Builder(this)
                .enableAutoManage(this, new GoogleApiClient.OnConnectionFailedListener() {
                    ...
                    public void onConnectionFailed(@NonNull ConnectionResult connectionResult) {
                        Toast.makeText(LoginActivity.this, R.string.connectionToGoogleFailed, Toast.LENGTH_SHORT).show();
                    }
                })
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {// якщо можна війти через аккаунт гугл, тоді переходимо на головну сторінку
        ...
        if (requestCode == RC_SIGN_IN) {
            ...
            if (result.isSuccess()){
                ...
                Toast.makeText(this, R.string.pleaseWait, Toast.LENGTH_SHORT).show();
            }else{
                Toast.makeText(this, R.string.cantGetAuthresult, Toast.LENGTH_SHORT).show();
            }
        }
    }
